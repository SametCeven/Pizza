    ...
    return(
        <nav className="mainpage-nav">
            <div className="mainpage-navitem">
                <img src="../images/iteration-2-images/icons/1.svg" alt="korean" />
            ...
            <div className="mainpage-navitem">
                <img src="../images/iteration-2-images/icons/4.svg" alt="friedfoods" />
                <Link to="/OrderForm">Fried Food</Link>
            </div>
            <div className="mainpage-navitem">
                <img src="../images/iteration-2-images/icons/5.svg" alt="fastfood" />
                <Link to="/OrderForm">Fast Food</Link>
            </div>
            <div className="mainpage-navitem">
                <img src="../images/iteration-2-images/icons/6.svg" alt="sodas" />
